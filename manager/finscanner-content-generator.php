...
include "api/finscanner-fetch-data-api.php";

	if(isset($ins)&& $ins){
	include "api/ai-api.php";
	}
	
header("location:finscanner-content-generator.php?msg=$messagess&css=$css");exit;
...
<div class="form-group ">
														<div class="row row-sm">
															<div class="col-md-12">
																<label class="form-label">Enter <?=$ptitle;?> Company URL <small class="category">Enter URl Like - https://www.finscanner.io/products/cashdash-uk-ltd/</small></label>
															</div>
															<div class="col-md-12">
