...
include "api/payrate-fetch-data-api.php";

	if(isset($ins)&& $ins){
	include "api/ai-api.php";
	}
	
header("location:payrate-content-generator.php?msg=$messagess&css=$css");exit;
...
<div class="form-group ">
														<div class="row row-sm">
															<div class="col-md-12">
																<label class="form-label">Enter <?=$ptitle;?> Company URL <small class="category">Enter URl Like - https://payrate42.com/listings/paygarden/</small></label>
															</div>
															<div class="col-md-12">
