                ...
                <div class="main-container container-fluid">
                    <div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5"><i class="fa-solid fa-code text-primary me-2"></i><?=$pagetitle;?> AI</h2>
								<ol class="breadcrumb">
...
<div class="col-md-12">
<label class="form-label  my-2 ps-1">Programming Language :</label>
<select name="language" class="form-control select-lg select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" title="Programming Language" required>
