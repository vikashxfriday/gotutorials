                ...
                <div class="main-container container-fluid">
                    <div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">User Activity</h2>
								<ol class="breadcrumb">
											...
											<table class="table card-table table-striped table-vcenter text-nowrap mb-0">
												<thead>
													<tr>
														...
														<th class="col"><span>Activity Title</span></th>
														<th class="col"><span>Added By</span></th>
...
<tr>
														...
														<td><?=get_user_field_by_id($val['addedby'],"admin_user");?> (<?=$val['addedby'];?>)</td>
														<td><?=$val['ip'];?></td>
                                                        <td><?=$val['addedon'];?></td>
