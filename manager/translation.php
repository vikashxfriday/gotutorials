...
$lan_from=trim($_POST['lan_from']);
$lan_to=trim($_POST['lan_to']);
                ...
                <div class="main-container container-fluid">
                    <div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5"><i class="fa-solid fa-language text-primary me-2"></i><?=$pagetitle;?> AI</h2>
								<ol class="breadcrumb">
...
<div class="col-md-6">
<label class="form-label  my-2 ps-1">Language From :</label>
<select name="lan_from" class="form-control select-lg select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" title="Admin Type" required>
...
<div class="col-md-6">
<label class="form-label  my-2 ps-1">Language To</label>
<select name="lan_to" class="form-control select-lg select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" title="Language To" required>
...
<div class="col-md-12"><label class="form-label  my-2 ps-1">Content for <?=$pagetitle;?></label></div>
<div class="col-md-12">
