                ...
                <div class="main-container container-fluid">
                    <div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">PSPBOX Content History</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">PSPBOX Content History</li>
								</ol>
							</div>
								...
								<div class="card custom-card">
									<div class="card-header border-bottom-0 pb-0">
										<div class="d-flex justify-content-between">
											<label class="main-content-label mb-0 pt-1">PSPBOX Data List</label>
...
<a class="dropdown-item" href="include/download-content-excel.php?sid=pspbox"><i class="fa-regular fa-file-excel text-danger" style="font-size: 18px;" title="Download Excel File"></i>&nbsp;Excel</a>
<a class="dropdown-item" href="include/download-content-word.php?sid=pspbox"><i class="fa fa-file-word-o text-info" style="font-size: 18px;" title="Download Word File"></i>&nbsp;Word</a>
<a class="dropdown-item" href="view-html.php?sid=pspbox"><i class="fa-brands fa-chrome text-warning" style="font-size: 18px;" title="Html View"></i>&nbsp;Html</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="card-body">
										<div class="table-responsive border userlist-table">
											<table class="table card-table table-striped table-vcenter text-nowrap mb-0">
												<thead>
													<tr>
													    <th class="wd-lg-20p" style="min-width:110px;"><span>Logo</span></th>
...
$fetch_fields="*";
$where_condation=" AND `source`='pspbox' ORDER BY `company_name` ASC";
...
<img src="<?=$rs['company_logo'];?>" title="<?=$rs['company_name'];?>" style="height:100px;width:100px;" />
<? } ?></td>
<td><?php echo trim($rs['company_name']);?></strong><br>
						<p class="d-inline-block text-truncate" style="max-width: 150px;" title="<?=$rs['company_url'];?>"><a href="<?=$rs['company_url'];?>" title="Move to website" target="_blank"><?php echo $rs['company_url'];?></a></p><br>
                        Email : <?php echo trim($rs['company_email']);?><br>
						<?php echo date("d F Y",strtotime($rs['addedon']));?></td>
<td class="col contact-css">
<?php echo $rs['company_categories'];?></td>
<td class="col contact-css">
<?php echo $rs['company_contact'];?></td>
														<td>
<div class="next_tr_<?=$rs['content_id'];?> row" style="display:none;">
<div class="mboxtitle" style="display:none;"><?=$rs['company_name'];?></div>
<div class="row">
					<div class="col-md-12 row" >
					<div class="col-md-8"><strong><?=$rs['company_name'];?></strong><br><a href="<?=$rs['company_url'];?>" title="ove to website" target="_blank"><?=$rs['company_url'];?></a></<br><?=$rs['source_url'];?><br><?=$rs['company_email'];?></div>
                    ...
                    <? } ?></div>
					  ...
					  <div class="col-md-6" >
                        ...
                        <?=$rs['solutions'];?>
					  	...
					  	<div class="col-md-6" >
					    <h4> <strong>Accepted Industries</strong> </h4>
                        <?=$rs['accepted_industries'];?>
                      </div>
					  	<div class="col-md-6" >
					  ...
					  <div class="col-md-6" >
					    <h4> <strong>Risk Appetite</strong> </h4>
                        <?=$rs['risk_appetite'];?>
                      </div>				  
